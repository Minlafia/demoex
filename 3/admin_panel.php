                            ...
                            <tr>
                                ...
                                <td>
                                    <select class="form-control" onchange="changeStatus(${application.id}, this.value)">
                                        ...
                                        <option value="подтверждено" ${application.status === "подтверждено" ? 'selected' : ''}>В работе</option>
                                        <option value="отклонено" ${application.status === "отклонено" ? 'selected' : ''}>Отменено</option>
                                        <option value="выполнено" ${application.status === "выполнено" ? 'selected' : ''}>Выполнено</option>
                                    </select>
                                </td>
                            </tr>
                        `);
