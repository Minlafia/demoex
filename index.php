...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center">Добро пожаловать в Систему Заявлений</h2>
        <p class="text-center">На этой странице вы можете:</p>
        <ul>
            <li>Создать новое заявление о нарушении</li>
            <li>Войти в систему как гражданин для просмотра своих заявлений</li>
            <li>Войти в систему как администратор для управления всеми заявлениями</li>
        </ul>
    </div>
